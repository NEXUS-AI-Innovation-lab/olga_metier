...
// Fonction utilitaire pour vérifier si une tâche est un rendez-vous médical
...
export default () => {
    ...
    // États pour gérer le formulaire, les données, l'ID de la tâche et le chargement
    const [form, setForm] = useState<Form | null>(null)
    const [formData, setFormData] = useState<any>(null)
    const [taskID, setTaskId] = useState("")
    const [loading, setLoading] = useState(false)

    // Récupération des tâches en cours via react-query
    ...
    return <div className="flex flex-col">
        ...
        <div className="flex-1 flex-col gap-5 pt-10 flex items-center justify-center ">
            {/* Bouton pour démarrer une nouvelle tâche (prise de rendez-vous) */}
            ...
            {/* Affichage des tâches de type rendez-vous */}
            ...
            {/* Modal pour afficher et remplir le formulaire de prise de rendez-vous */}
                ...
                <ModalContent>
                    {(onClose) => (
                        <>{form != null && <>
                            ...
                            <ModalBody>
                                {/* Interpréteur de formulaire pour saisir les données */}
                            ...
                            <ModalFooter>
                                ...
                                {/* Bouton pour envoyer les données du formulaire et passer à l'étape suivante */}
